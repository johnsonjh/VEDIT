...
;
;	Last Change: TnT - Dec. 09, 1986 - 2.03 changes
;		     Tom - Feb. 2x, 1987 - PRCSPX() not clear ERRFLG for CR,LF
;			   Mar. 05 - GETSTR(#ESC) fix for keeping ? in FIND[] & REPLACE[]
;
MOVE3:	MVI	C,3
	JMP	MOVE
;
...
..1:	MVI	M,'"'		;Insert end quote and msg termination bit
	...
	JMP	MSBR8K		;;Display message & BREAK out to command main
	EPROC	CCBR8K
	.PAGE
;
...
;
..2:	LXI	H,CMDPMT	;HL -> command prompt
...
;
;	   NOTE: Changes INPFLG.  Should be changed to restore INPFLG!
;
