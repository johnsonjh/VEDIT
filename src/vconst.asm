...
MSTKMX	=	256
QRGMAX	=	100		;Max user-definable numerical registers
	]
...
XSTKMX	=	6		;Max register exection stack levels
	...
	IF	MSDOS, [
PSTRUC	=	33+4		;Start of pathname structure:  offset to FN
PATHBG	=	PSTRUC+2	;Start of pathname string
DIRLEN	=	2+64+17		;FN OFS,d:\path64\file8.ex3,0
	]
