...
;
;	Last Change: Tom - Jan. 13 - MAKSPC return 'C'/'NC' from WRTTXT
;		     Ted - Jan. 26 - New routine JAMUP (of Nov. 13, 1985)
;			 - Mar. 25 - WRTTXT() calls WRITE() directly
;			 - Mar. 26 - Delete TEXTRM, misc
;			   Apr. 07 - Use MIDBAS in place of CMBASE
;			   May  09 - Optimize NEXFIL()
;		     Tom - May  09 - CNTFL0, new e.p. optimization
;			   May  13 - JAMFL set by JAMUP, cleared by JAMDWN
;			   Oct. 03 - NEXFIL overflow-bug fix
;		     Ted - Oct. 13 - new routine INFLCK
;			   Oct. 13 - Return when WRTTXT writes 00 bytes
;			   Oct. 28 - Modified use of VISMSS and NWSCFL
;		     Tom - Oct. 20 - Read files w/o LF's:  EOLLIN(), SAVBGN() renamed BOFLIN()
;			   Oct. 25 - NEXFIL() not NEXFR3() after write error
;
