...
;	INIDVA = 1, normally 1
;
;	ULCSW = ES(13), normally nonexistent			[8/23/85]
;	ULCSW checked in SCRNTG, branch to CHGCAS if set
;
;
...
;
	.IFN	COMMON - 12, [	;If not a custom version, set defaults
POLLING  =	1		;Set polling on
BASEVR  =	1		;Default base at 0000H
	 ]
;
	.IFE	COMMON - 11, [	;If this is a PIICEON
...
;
	.IFN	COMMON - 3, [
DECRAIN =	0		;If not 8080 CRT version
	]
;
;
;
