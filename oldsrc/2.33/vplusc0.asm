...
FNFBRK:	LXI	H,FNFMS2	;HL-> FNF msg
	TST$	WWMODE		;Visual mode?
	JNZ	MSGBRK		;Yes, BREAK
...
;
BRKC1:	TST$	WWMODE		;Command mode?
	JRZ	BREAK		;Yes, give BREAK msg
	LXI	H,NULMSG	;No, don't bother flashing msg on status line
	XRA	A
	JMPR	BRK0
	EPROC	BREAKC
...
;
				;{BREAK^,CMBR8K,ERRHND,VESC}
BR8K:	CALL	RESTOP		;Restore top of window if not already
