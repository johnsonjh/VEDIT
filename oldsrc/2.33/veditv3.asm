...
STAPRM:	XRA	A		;Start message at column 0
	...
	CALL	ATTBCK		;User reply in screen background attribute
	JMP	WINEOL		;;Erase rest of status line
;
...
STADON:	CALL	SV%BDH		;Save regs
	CPIB$	WWNAME,01	;Is output going to status line now?
...
;
	CPIB$	WWNAME,01	;Already set to status line?
	BEQ	..1		;Yes, branch
